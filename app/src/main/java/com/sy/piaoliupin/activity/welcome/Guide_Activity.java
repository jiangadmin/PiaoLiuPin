...
public class Guide_Activity extends Base_Activity implements View.OnClickListener {
    ...
    protected void initview() {
        ...
        img1.setImageResource(R.drawable.start_image);

        img2.setLayoutParams(params);
        img2.setScaleType(ImageView.ScaleType.FIT_XY);
        img2.setBackgroundResource(R.drawable.start_image);

        img3.setLayoutParams(params);
        img3.setScaleType(ImageView.ScaleType.FIT_XY);
        img3.setBackgroundResource(R.drawable.start_image);
    ...
    private class GuideAdapter extends PagerAdapter {
        ...
        @Override
        public int getCount() {
            LogUtil.d(TAG, listImgs.get(1).getBackground().toString());
