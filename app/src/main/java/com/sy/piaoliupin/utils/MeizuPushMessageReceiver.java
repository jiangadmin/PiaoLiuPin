...
public class MeizuPushMessageReceiver extends MzPushMessageReceiver {
    ...
    public void onRegisterStatus(Context context, RegisterStatus registerStatus) {
        LogUtil.d(TAG, "pushId: " + registerStatus.getPushId() + "|Expiretime: " + registerStatus.getExpireTime() + "|str: " + registerStatus.toString());
        ...
        TIMManager.getInstance().setOfflinePushToken(token, new TIMCallBack() {
            ...
            public void onError(int i, String s) {
                LogUtil.e(TAG, "setOfflinePushToken failed, code: " + i + "|msg: " + s);
            }

            @Override
            public void onSuccess() {
                LogUtil.i(TAG, "setOfflinePushToken succ");
            }
        });
    }
    ...
    public void onNotificationClicked(Context context, MzPushMessage mzPushMessage) {
        ...
        LogUtil.i(TAG, "onNotificationClicked content: " + content + "|selfDefined ext: " + ext);
    }
