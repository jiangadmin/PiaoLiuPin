...
public class MiPushMessageReceiver extends PushMessageReceiver {
    ...
    public void onReceivePassThroughMessage(Context context, MiPushMessage message) {
        ...
        LogUtil.e(TAG, getSimpleDate() + " " + message.getContent());
        ...
        LogUtil.e(TAG, "regId: " + mRegId + " | topic: " + mTopic + " | alias: " + mAlias
...
//        MiPushClient.clearNotification(context);
    ...
    public void onCommandResult(Context context, MiPushCommandMessage message) {
        LogUtil.e(TAG, "onCommandResult is called. " + message.toString());
        String command = message.getCommand();
        List<String> arguments = message.getCommandArguments();
        String cmdArg1 = ((arguments != null && arguments.size() > 0) ? arguments.get(0) : null);
        String cmdArg2 = ((arguments != null && arguments.size() > 1) ? arguments.get(1) : null);

        LogUtil.e(TAG, "cmd: " + command + " | arg1: " + cmdArg1 + " | arg2: " + cmdArg2
    ...
    public void onReceiveRegisterResult(Context context, MiPushCommandMessage message) {
        LogUtil.e(TAG, "onReceiveRegisterResult is called. " + message.toString());
        String command = message.getCommand();
        List<String> arguments = message.getCommandArguments();
        String cmdArg1 = ((arguments != null && arguments.size() > 0) ? arguments.get(0) : null);

        LogUtil.e(TAG, "cmd: " + command + " | arg: " + cmdArg1
                + " | result: " + message.getResultCode() + " | reason: " + message.getReason());
