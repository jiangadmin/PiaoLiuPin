...
public class ProfileActivity extends Base_Activity implements FriendshipManageView, View.OnClickListener {
    ...
    public void showProfile(final String identify) {
        ...
        LineControllerView id = findViewById(R.id.id);
        id.setContent(profile.getIdentify());
        final LineControllerView remark = findViewById(R.id.remark);
        ...
        LineControllerView black = findViewById(R.id.blackList);
