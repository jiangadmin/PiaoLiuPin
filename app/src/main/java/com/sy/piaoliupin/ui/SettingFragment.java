...
public class SettingFragment extends Fragment implements FriendInfoView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view == null) {
            ...
            friendConfirm = view.findViewById(R.id.friendConfirm);
            ...
            LineControllerView messageNotify = view.findViewById(R.id.messageNotify);
            ...
            LineControllerView blackList = view.findViewById(R.id.blackList);
...
//                    startActivity(intent);
            ...
            LineControllerView about = view.findViewById(R.id.about);
