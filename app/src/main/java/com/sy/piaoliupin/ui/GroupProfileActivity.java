...
public class GroupProfileActivity extends FragmentActivity implements GroupInfoView, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intro = findViewById(R.id.groupIntro);
        LinearLayout controlInGroup = findViewById(R.id.controlInGroup);
        controlInGroup.setVisibility(isInGroup ? View.VISIBLE : View.GONE);
        TextView controlOutGroup = findViewById(R.id.controlOutGroup);
    ...
    public void showGroupInfo(List<TIMGroupDetailInfo> groupInfos) {
        ...
        LineControllerView member = findViewById(R.id.member);
        if (isInGroup) {
        ...
        LineControllerView id = findViewById(R.id.idText);
        id.setContent(info.getGroupId());

        intro.setContent(info.getGroupIntroduction());
        LineControllerView opt = findViewById(R.id.addOpt);
        ...
        LineControllerView msgNotify = findViewById(R.id.messageNotify);
        ...
        TextView btnDel = findViewById(R.id.btnDel);
                ...
                if (isGroupOwner) {
                    GroupManagerPresenter.dismissGroup(identify, new TIMCallBack() {
                        ...
                        public void onError(int i, String s) {
                            LogUtil.i(TAG, "onError code" + i + " msg " + s);
