...
import com.sy.piaoliupin.model.ImageMessage;
import com.sy.piaoliupin.model.Message;
import com.sy.piaoliupin.model.MessageFactory;
import com.sy.piaoliupin.model.TextMessage;
import com.sy.piaoliupin.model.UGCMessage;
import com.sy.piaoliupin.model.VideoMessage;
import com.sy.piaoliupin.model.VoiceMessage;
import com.sy.piaoliupin.presenter.ChatPresenter;
...
//        RefreshEvent.getInstance().onRefresh();
    ...
    private void sendFile(String path) {
        ...
        if (file.exists()) {
            if (file.length() > 1024 * 1024 * 10) {
                TabToast.makeText(getString(R.string.chat_file_too_large));
            } else {
                Message message = new FileMessage(path);
                presenter.sendMessage(message.getMessage());
            }
        } else {
            TabToast.makeText(getString(R.string.chat_file_not_exist));
        }
